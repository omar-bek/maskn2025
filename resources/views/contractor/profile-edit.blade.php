...
@section('title', 'تعديل ملف المقاول')
    ...
    <div class="bg-[#0f1c1f] min-h-screen py-20">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-8">
                <div>
                    <p class="text-sm uppercase tracking-widest text-[#f3a446]">ملفي</p>
                    <h1 class="text-3xl font-extrabold text-white">تحديث بيانات المقاول</h1>
                    <p class="text-gray-300 mt-2">قم بتحديث معلومات شركتك وتفاصيل التواصل للحفاظ على ثقة العملاء.</p>
                </div>
            ...
            <div class="bg-white rounded-3xl shadow-2xl p-8">
                <form action="{{ route('contractor.profile.update') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label class="block text-sm font-semibold text-[#1a262a] mb-2">اسم الشركة</label>
