                ...
                <div class="bg-white rounded-lg shadow-md p-6 mb-6 sticky top-4">
                    ...
                    <div class="space-y-4 mb-6">
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <span class="bg-teal-100 text-teal-800 px-2 py-1 rounded text-sm">{{ $design['style'] }}</span>
                        </div>
                        <div class="flex justify-between items-center">
                    ...
                    <div class="space-y-3">
                        ...
                        <button class="w-full border border-gray-300 text-gray-700 py-3 rounded-lg font-semibold hover:bg-gray-50 transition duration-300">
        ...
        <div class="bg-white rounded-lg max-w-md w-full p-6">
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input type="number" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500" value="400">
                </div>
                <div>
