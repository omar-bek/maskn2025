    ...
    <div class="container mx-auto px-4 py-8">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="flex flex-wrap gap-2">
                            @foreach ($features as $feature)
                                <span
                                    class="bg-blue-100 text-blue-800 px-3 py-1 rounded-full text-sm">{{ $feature }}</span>
                            @endforeach
                        </div>
                    </div>
                @endif
        ...
        <div class="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg p-6 mb-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div class="text-center">
                    <div class="text-3xl font-bold text-orange-600">{{ number_format($totalAmount / $design->area, 2) }}
                    </div>
                    ...
                    <tbody class="divide-y divide-gray-200">
                        @foreach ($categoryTotals as $categoryTotal)
                            <tr class="hover:bg-gray-50">
                                <td class="px-4 py-3 text-sm font-medium text-gray-900">{{ $categoryTotal->category_name }}
                                </td>
