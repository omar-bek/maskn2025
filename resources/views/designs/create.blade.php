                    ...
                    <table class="w-full">
                        <tbody class="space-y-4">
                            ...
                            <tr>
                                ...
                                <option value="modern" {{ old('style') == 'modern' ? 'selected' : '' }}>عصري</option>
                                <option value="islamic" {{ old('style') == 'islamic' ? 'selected' : '' }}>إسلامي</option>
                                <option value="traditional" {{ old('style') == 'traditional' ? 'selected' : '' }}>تقليدي</option>
                                <option value="classic" {{ old('style') == 'classic' ? 'selected' : '' }}>كلاسيكي</option>
                                <option value="minimalist" {{ old('style') == 'minimalist' ? 'selected' : '' }}>مينيمال</option>
                            </select>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="py-3">
                                    <textarea name="description" rows="4" required
                                              class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                  placeholder="اكتب وصفاً مفصلاً للتصميم...">{{ old('description', '') }}</textarea>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                                ...
                                <td class="py-3">
                                    <div class="grid grid-cols-2 gap-4">
                                        <label class="flex items-center">
                                            <input type="checkbox" name="features[]" value="حديقة خارجية" class="ml-3" {{ in_array('حديقة خارجية', old('features', [])) ? 'checked' : '' }}>
                                            <span class="text-sm text-gray-700">حديقة خارجية</span>
                                        </label>
                                        <label class="flex items-center">
                                            <input type="checkbox" name="features[]" value="موقف سيارات" class="ml-3" {{ in_array('موقف سيارات', old('features', [])) ? 'checked' : '' }}>
                                            <span class="text-sm text-gray-700">موقف سيارات</span>
                                        </label>
                                        <label class="flex items-center">
                                            <input type="checkbox" name="features[]" value="مطبخ مجهز" class="ml-3" {{ in_array('مطبخ مجهز', old('features', [])) ? 'checked' : '' }}>
                                            <span class="text-sm text-gray-700">مطبخ مجهز</span>
                                        </label>
                                        <label class="flex items-center">
                                            <input type="checkbox" name="features[]" value="غرفة معيشة واسعة" class="ml-3" {{ in_array('غرفة معيشة واسعة', old('features', [])) ? 'checked' : '' }}>
                                            <span class="text-sm text-gray-700">غرفة معيشة واسعة</span>
                                        </label>
                                        <label class="flex items-center">
                                            <input type="checkbox" name="features[]" value="مسبح خاص" class="ml-3" {{ in_array('مسبح خاص', old('features', [])) ? 'checked' : '' }}>
                                            <span class="text-sm text-gray-700">مسبح خاص</span>
                                        </label>
                                        <label class="flex items-center">
                                            <input type="checkbox" name="features[]" value="مصعد داخلي" class="ml-3" {{ in_array('مصعد داخلي', old('features', [])) ? 'checked' : '' }}>
                                            <span class="text-sm text-gray-700">مصعد داخلي</span>
                                        </label>
                                        <label class="flex items-center">
                                            <input type="checkbox" name="features[]" value="شرفات" class="ml-3" {{ in_array('شرفات', old('features', [])) ? 'checked' : '' }}>
                                            <span class="text-sm text-gray-700">شرفات</span>
                                        </label>
                                        <label class="flex items-center">
                                            <input type="checkbox" name="features[]" value="مخازن" class="ml-3" {{ in_array('مخازن', old('features', [])) ? 'checked' : '' }}>
