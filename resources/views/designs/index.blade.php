...
<style>
    ...
    .designs-hero .text-gray-600 {
        color: #d1d5db; /* Light Gray for dark background */
    }
    ...
    .design-image {
        position: relative;
        overflow: hidden; /* Crucial for image zoom */
        height: 220px;
    }
    ...
    .btn-primary.bg-blue-600 { background-color: #2563eb; border-color: #2563eb; color: white; }
    .btn-primary.bg-blue-600:hover { background-color: #1d4ed8; border-color: #1d4ed8; }
    .btn-secondary.bg-red-600 { background-color: #dc2626; border-color: #dc2626; color: white; }
    .btn-secondary.bg-red-600:hover { background-color: #b91c1c; border-color: #b91c1c; }
...
<style>
    ...
    .inspiration-section.is-visible .inspiration-card:nth-child(1) { transition-delay: 0.1s; }
    .inspiration-section.is-visible .inspiration-card:nth-child(2) { transition-delay: 0.2s; }
    .inspiration-section.is-visible .inspiration-card:nth-child(3) { transition-delay: 0.3s; }
    ...
    @keyframes subtleGlow {
        0% { box-shadow: 0 10px 40px rgba(0, 0, 0, 0.5), 0 0 15px rgba(243, 164, 70, 0.2); }
        50% { box-shadow: 0 10px 40px rgba(0, 0, 0, 0.5), 0 0 30px rgba(243, 164, 70, 0.4); }
        100% { box-shadow: 0 10px 40px rgba(0, 0, 0, 0.5), 0 0 15px rgba(243, 164, 70, 0.2); }
    }
