    ...
    function filterDesigns(category) {
        ...
        cards.forEach(card => {
            ...
            <div class="design-card" data-category="traditional">
                <div class="design-image">
                    <img src="https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="فيلا تراثية">
                    <div class="design-overlay">
                        <div class="overlay-content">
            ...
            <div class="design-card" data-category="minimal modern">
                <div class="design-image">
                    <img src="https://images.unsplash.com/photo-1545324418-cc1a3fa10c00?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="شقة بسيطة">
                    <div class="design-overlay">
                        <div class="overlay-content">
            ...
            <div class="design-card" data-category="luxury modern">
                <div class="design-image">
                    <img src="https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="فيلا فاخرة">
                    <div class="design-overlay">
                        <div class="overlay-content">
            ...
            <div class="design-card" data-category="classic">
                <div class="design-image">
                    <img src="https://images.unsplash.com/photo-1600607687644-c7171b42498b?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="فيلا كلاسيكية">
                    <div class="design-overlay">
                        <div class="overlay-content">
                            <div class="overlay-title">فيلا كلاسيكية</div>
