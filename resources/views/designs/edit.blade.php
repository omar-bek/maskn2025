    ...
    <div class="bg-white rounded-lg shadow-lg overflow-hidden">
                    ...
                    <table class="w-full">
                        <tbody class="space-y-4">
                            ...
                            <tr>
                                ...
                                <option value="modern" {{ old('style', $design->style) == 'modern' ? 'selected' : '' }}>عصري</option>
                                <option value="islamic" {{ old('style', $design->style) == 'islamic' ? 'selected' : '' }}>إسلامي</option>
                                <option value="traditional" {{ old('style', $design->style) == 'traditional' ? 'selected' : '' }}>تقليدي</option>
                                <option value="classic" {{ old('style', $design->style) == 'classic' ? 'selected' : '' }}>كلاسيكي</option>
                                <option value="minimalist" {{ old('style', $design->style) == 'minimalist' ? 'selected' : '' }}>مينيمال</option>
                            </select>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="py-3">
                                    <div class="grid grid-cols-2 gap-4">
                                        <label class="flex items-center">
                                            <input type="checkbox" name="features[]" value="حديقة خارجية" class="ml-3" {{ in_array('حديقة خارجية', old('features', $design->features ?? [])) ? 'checked' : '' }}>
                                            <span class="text-sm text-gray-700">حديقة خارجية</span>
                                        </label>
                                        <label class="flex items-center">
                                            <input type="checkbox" name="features[]" value="موقف سيارات" class="ml-3" {{ in_array('موقف سيارات', old('features', $design->features ?? [])) ? 'checked' : '' }}>
                                            <span class="text-sm text-gray-700">موقف سيارات</span>
                                        </label>
                                        <label class="flex items-center">
                                            <input type="checkbox" name="features[]" value="مطبخ مجهز" class="ml-3" {{ in_array('مطبخ مجهز', old('features', $design->features ?? [])) ? 'checked' : '' }}>
                                            <span class="text-sm text-gray-700">مطبخ مجهز</span>
                                        </label>
                                        <label class="flex items-center">
                                            <input type="checkbox" name="features[]" value="غرفة معيشة واسعة" class="ml-3" {{ in_array('غرفة معيشة واسعة', old('features', $design->features ?? [])) ? 'checked' : '' }}>
                                            <span class="text-sm text-gray-700">غرفة معيشة واسعة</span>
                                        </label>
                                        <label class="flex items-center">
                                            <input type="checkbox" name="features[]" value="مسبح خاص" class="ml-3" {{ in_array('مسبح خاص', old('features', $design->features ?? [])) ? 'checked' : '' }}>
                                            <span class="text-sm text-gray-700">مسبح خاص</span>
                                        </label>
                                        <label class="flex items-center">
                                            <input type="checkbox" name="features[]" value="مصعد داخلي" class="ml-3" {{ in_array('مصعد داخلي', old('features', $design->features ?? [])) ? 'checked' : '' }}>
                                            <span class="text-sm text-gray-700">مصعد داخلي</span>
                                        </label>
                                        <label class="flex items-center">
                                            <input type="checkbox" name="features[]" value="شرفات" class="ml-3" {{ in_array('شرفات', old('features', $design->features ?? [])) ? 'checked' : '' }}>
                                            <span class="text-sm text-gray-700">شرفات</span>
                                        </label>
                                        <label class="flex items-center">
                                            <input type="checkbox" name="features[]" value="مخازن" class="ml-3" {{ in_array('مخازن', old('features', $design->features ?? [])) ? 'checked' : '' }}>
                                ...
                                <td class="py-3">
                                    @if($design->main_image)
                                        <div class="mb-4">
                                            ...
                                            <img src="{{ asset('storage/' . $design->main_image) }}" alt="الصورة الحالية" class="w-32 h-32 object-cover rounded-lg">
                                        </div>
                                    @endif
                            ...
                            <tr>
                                ...
                                <td class="py-3">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <div class="grid grid-cols-3 gap-2">
                                                @foreach($design->images as $image)
                                                    <img src="{{ asset('storage/' . $image) }}" alt="صورة إضافية" class="w-20 h-20 object-cover rounded-lg">
                                                @endforeach
                                            </div>
                                        </div>
                                    @endif
                                    <input type="file" name="images[]" accept="image/*" multiple
                                           class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                                    <p class="text-sm text-gray-500 mt-1">اتركه فارغاً للاحتفاظ بالصور الحالية، أو اختر صوراً جديدة لاستبدالها</p>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                ...
                <div class="p-6">
                    <div class="space-y-6">
                        ...
                        <div class="border rounded-lg bg-gray-50">
                            ...
                            <div class="p-4">
                                <div class="overflow-x-auto">
                                    <table class="w-full border-collapse border border-gray-300">
                                        <thead class="bg-white">
                                            <tr>
                                                <th class="border border-gray-300 px-3 py-2 text-right text-sm font-semibold text-gray-700">اسم البند</th>
                                                <th class="border border-gray-300 px-3 py-2 text-center text-sm font-semibold text-gray-700">الكمية</th>
                                                <th class="border border-gray-300 px-3 py-2 text-center text-sm font-semibold text-gray-700">الوحدة</th>
                                                <th class="border border-gray-300 px-3 py-2 text-center text-sm font-semibold text-gray-700">سعر الوحدة (ريال)</th>
                                                <th class="border border-gray-300 px-3 py-2 text-center text-sm font-semibold text-gray-700">المجموع (ريال)</th>
                                                <th class="border border-gray-300 px-3 py-2 text-center text-sm font-semibold text-gray-700">العمليات</th>
                                            </tr>
                                        </thead>
                                        <tbody id="category-1-items">
                                            <tr class="pricing-row">
                                                ...
                                                <td class="border border-gray-300 px-3 py-2">
                                                    <select name="pricing[1][0][unit]" class="w-full border border-gray-300 rounded px-2 py-1 text-sm">
                                ...
                                <button type="button" class="mt-2 text-blue-600 hover:text-blue-800 text-sm add-item-btn" data-category="1">
                        ...
                        <div class="border rounded-lg bg-gray-50">
                            ...
                            <div class="p-4">
                                    ...
                                    <table class="w-full border-collapse border border-gray-300">
                                        ...
                                        <tbody id="category-2-items">
                                            <tr class="pricing-row">
                                                ...
                                                <td class="border border-gray-300 px-3 py-2">
                                                    <select name="pricing[2][0][unit]" class="w-full border border-gray-300 rounded px-2 py-1 text-sm">
                                                        <option value="م²">م²</option>
                                                        <option value="م³">م³</option>
                                                        <option value="م">م</option>
                                                        <option value="قطعة">قطعة</option>
                                ...
                                <button type="button" class="mt-2 text-blue-600 hover:text-blue-800 text-sm add-item-btn" data-category="2">
                                    <i class="fas fa-plus ml-1"></i> إضافة بند
                                </button>
                            </div>
                        </div>
                        ...
                        <div class="border rounded-lg bg-gray-50">
                            ...
                            <div class="p-4">
                                    ...
                                    <table class="w-full border-collapse border border-gray-300">
                                        ...
                                        <tbody id="category-3-items">
                                            <tr class="pricing-row">
                                                ...
                                                <td class="border border-gray-300 px-3 py-2">
                                                    <select name="pricing[3][0][unit]" class="w-full border border-gray-300 rounded px-2 py-1 text-sm">
                                                        <option value="م²">م²</option>
                                                        <option value="م³">م³</option>
                                                        <option value="م">م</option>
                                                        <option value="قطعة">قطعة</option>
                                ...
                                <button type="button" class="mt-2 text-blue-600 hover:text-blue-800 text-sm add-item-btn" data-category="3">
                                    <i class="fas fa-plus ml-1"></i> إضافة بند
                                </button>
                            </div>
                        </div>
                        ...
                        <div class="border rounded-lg bg-gray-50">
                            ...
                            <div class="p-4">
                                    ...
                                    <table class="w-full border-collapse border border-gray-300">
                                        ...
                                        <tbody id="category-4-items">
                                            <tr class="pricing-row">
                                                ...
                                                <td class="border border-gray-300 px-3 py-2">
                                                    <select name="pricing[4][0][unit]" class="w-full border border-gray-300 rounded px-2 py-1 text-sm">
                                                        <option value="م">م</option>
                                                        <option value="م²">م²</option>
                                                        <option value="م³">م³</option>
                                                        <option value="قطعة">قطعة</option>
                                ...
                                <button type="button" class="mt-2 text-blue-600 hover:text-blue-800 text-sm add-item-btn" data-category="4">
                                    <i class="fas fa-plus ml-1"></i> إضافة بند
                                </button>
                            </div>
                        </div>
                        ...
                        <div class="border rounded-lg bg-gray-50">
                            ...
                            <div class="p-4">
                                    ...
                                    <table class="w-full border-collapse border border-gray-300">
                                        ...
                                        <tbody id="category-5-items">
                                            <tr class="pricing-row">
                                                ...
                                                <td class="border border-gray-300 px-3 py-2">
                                                    <select name="pricing[5][0][unit]" class="w-full border border-gray-300 rounded px-2 py-1 text-sm">
                                                        <option value="م">م</option>
                                                        <option value="م²">م²</option>
                                                        <option value="م³">م³</option>
                                                        <option value="قطعة">قطعة</option>
                                ...
                                <button type="button" class="mt-2 text-blue-600 hover:text-blue-800 text-sm add-item-btn" data-category="5">
                                    <i class="fas fa-plus ml-1"></i> إضافة بند
                                </button>
                            </div>
                        </div>
                        ...
                        <div class="border rounded-lg bg-gray-50">
                            ...
                            <div class="p-4">
                                    ...
                                    <table class="w-full border-collapse border border-gray-300">
                                        ...
                                        <tbody id="category-6-items">
                                            <tr class="pricing-row">
                                                ...
                                                <td class="border border-gray-300 px-3 py-2">
                                                    <select name="pricing[6][0][unit]" class="w-full border border-gray-300 rounded px-2 py-1 text-sm">
                                                        <option value="قطعة">قطعة</option>
                                                        <option value="م²">م²</option>
                                                        <option value="م">م</option>
                                                        <option value="م³">م³</option>
                                ...
                                <button type="button" class="mt-2 text-blue-600 hover:text-blue-800 text-sm add-item-btn" data-category="6">
                                    <i class="fas fa-plus ml-1"></i> إضافة بند
                                </button>
                            </div>
                        </div>
                        ...
                        <div class="border rounded-lg bg-gray-50">
                            ...
                            <div class="p-4">
                                    ...
                                    <table class="w-full border-collapse border border-gray-300">
                                        ...
                                        <tbody id="category-7-items">
                                            <tr class="pricing-row">
                                                ...
                                                <td class="border border-gray-300 px-3 py-2">
                                                    <select name="pricing[7][0][unit]" class="w-full border border-gray-300 rounded px-2 py-1 text-sm">
                                                        <option value="م²">م²</option>
                                ...
                                <button type="button" class="mt-2 text-blue-600 hover:text-blue-800 text-sm add-item-btn" data-category="7">
                                    <i class="fas fa-plus ml-1"></i> إضافة بند
                                </button>
                    </div>
                </div>
                        ...
                        <div class="border rounded-lg bg-gray-50">
                            ...
                            <div class="p-4">
                                    ...
                                    <table class="w-full border-collapse border border-gray-300">
                                        ...
                                        <tbody id="category-8-items">
                                            <tr class="pricing-row">
                                                ...
                                                <td class="border border-gray-300 px-3 py-2">
                                                    <select name="pricing[8][0][unit]" class="w-full border border-gray-300 rounded px-2 py-1 text-sm">
                                                        <option value="م²">م²</option>
                                                        <option value="قطعة">قطعة</option>
                                                        <option value="م">م</option>
                                                        <option value="كيلو">كيلو</option>
                                ...
                                <button type="button" class="mt-2 text-blue-600 hover:text-blue-800 text-sm add-item-btn" data-category="8">
                                    <i class="fas fa-plus ml-1"></i> إضافة بند
                                </button>
                            </div>
                        </div>
                        ...
                        <div class="border rounded-lg bg-gray-50">
                            ...
                            <div class="p-4">
                                    ...
                                    <table class="w-full border-collapse border border-gray-300">
                                        ...
                                        <tbody id="category-9-items">
                                            <tr class="pricing-row">
                                                ...
                                                <td class="border border-gray-300 px-3 py-2">
                                                    <select name="pricing[9][0][unit]" class="w-full border border-gray-300 rounded px-2 py-1 text-sm">
                                                        <option value="قطعة">قطعة</option>
                                                        <option value="م²">م²</option>
                                                        <option value="كيلو">كيلو</option>
                                ...
                                <button type="button" class="mt-2 text-blue-600 hover:text-blue-800 text-sm add-item-btn" data-category="9">
                                    <i class="fas fa-plus ml-1"></i> إضافة بند
                                </button>
                            </div>
                        </div>
                        ...
                        <div class="border rounded-lg bg-gray-50">
                            ...
                            <div class="p-4">
                                    ...
                                    <table class="w-full border-collapse border border-gray-300">
                                        ...
                                        <tbody id="category-10-items">
                                            <tr class="pricing-row">
                                                ...
                                                <td class="border border-gray-300 px-3 py-2">
                                                    <select name="pricing[10][0][unit]" class="w-full border border-gray-300 rounded px-2 py-1 text-sm">
                                                        <option value="م²">م²</option>
                                                        <option value="م³">م³</option>
                                                        <option value="كيلو">كيلو</option>
                                                        <option value="لتر">لتر</option>
                                ...
                                <button type="button" class="mt-2 text-blue-600 hover:text-blue-800 text-sm add-item-btn" data-category="10">
                                    <i class="fas fa-plus ml-1"></i> إضافة بند
                                </button>
                </div>
                        </div>
                        ...
                        <div class="border rounded-lg bg-gray-50">
                            ...
                            <div class="p-4">
                                    ...
                                    <table class="w-full border-collapse border border-gray-300">
                                        ...
                                        <tbody id="category-11-items">
                                            <tr class="pricing-row">
                                                ...
                                                <td class="border border-gray-300 px-3 py-2">
                                                    <select name="pricing[11][0][unit]" class="w-full border border-gray-300 rounded px-2 py-1 text-sm">
                                                        <option value="م">م</option>
                                                        <option value="قطعة">قطعة</option>
                                                        <option value="م²">م²</option>
                                                        <option value="م³">م³</option>
                                ...
                                <button type="button" class="mt-2 text-blue-600 hover:text-blue-800 text-sm add-item-btn" data-category="11">
                                    <i class="fas fa-plus ml-1"></i> إضافة بند
                                </button>
                            </div>
                        </div>
                        ...
                        <div class="border rounded-lg bg-gray-50">
                            ...
                            <div class="p-4">
                                    ...
                                    <table class="w-full border-collapse border border-gray-300">
                                        ...
                                        <tbody id="category-12-items">
                                            <tr class="pricing-row">
                                                ...
                                                <td class="border border-gray-300 px-3 py-2">
                                                    <select name="pricing[12][0][unit]" class="w-full border border-gray-300 rounded px-2 py-1 text-sm">
                                                        <option value="م²">م²</option>
                                                        <option value="م">م</option>
                                                        <option value="قطعة">قطعة</option>
                                                        <option value="م³">م³</option>
                                ...
                                <button type="button" class="mt-2 text-blue-600 hover:text-blue-800 text-sm add-item-btn" data-category="12">
                                    <i class="fas fa-plus ml-1"></i> إضافة بند
                                </button>
                            </div>
                        </div>
                    ...
                    <div class="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
                        ...
                        <table class="w-full">
                            <tbody>
                                <tr>
                                    <td class="py-2 text-right text-sm font-medium text-blue-700 w-1/4">المجموع الكلي:</td>
                                    <td class="py-2">
                                        <span class="text-2xl font-bold text-blue-600" id="total-cost">0.00</span>
                                        <span class="text-sm text-blue-700 mr-2">ريال</span>
                                    </td>
                                    <td class="py-2 text-right text-sm font-medium text-green-700 w-1/4">عدد البنود:</td>
                                    <td class="py-2">
                                ...
                                <tr>
                                    <td class="py-2 text-right text-sm font-medium text-purple-700 w-1/4">عدد الفئات:</td>
                                    <td class="py-2">
                                        <span class="text-xl font-bold text-purple-600">12</span>
                                        <span class="text-sm text-purple-700 mr-2">فئة</span>
                                    </td>
                                    <td class="py-2 text-right text-sm font-medium text-orange-700 w-1/4">متوسط التكلفة:</td>
                                    <td class="py-2">
            ...
            <div class="bg-gray-50 px-6 py-4">
                <div class="flex flex-col sm:flex-row gap-4">
                    <button type="submit" class="flex-1 bg-blue-600 text-white py-3 rounded-lg font-semibold hover:bg-blue-700 transition duration-300">
