...
@section('title', 'إنشاء مناقصة جديدة - انشاءات')
...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="bg-white rounded-lg shadow-lg p-6 mb-6">
        <div class="border-b pb-4 mb-6">
            <h1 class="text-3xl font-bold text-gray-900">إنشاء مناقصة جديدة</h1>
            <p class="text-gray-600 mt-2">أنشئ مناقصة للحصول على عروض من الاستشاريين</p>
        </div>
    </div>
                                ...
                                <td class="py-3">
                                    <div class="space-y-4">
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 max-h-96 overflow-y-auto border border-gray-200 rounded-lg p-4">
                                            ...
                                            <div class="design-option border-2 rounded-lg p-4 cursor-pointer transition-all duration-200 hover:border-blue-500 hover:shadow-md {{ old('design_id') == $design->id ? 'border-blue-500 bg-blue-50' : 'border-gray-200' }}"
                                                 onclick="selectDesign({{ $design->id }})">
                                                <input type="radio" name="design_id" value="{{ $design->id }}"
                                                       id="design_{{ $design->id }}"
                                                       class="sr-only"
                                                       {{ old('design_id') == $design->id ? 'checked' : '' }}>
                            ...
                            <tr>
                                ...
                                <td class="py-3">
                                    <textarea name="description" rows="4" required
                                              class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                              placeholder="اكتب وصفاً مفصلاً للمشروع المطلوب...">{{ old('description', '') }}</textarea>
                                </td>
                            </tr>
                        </tbody>
                    </table>
