        ...
        if ($lands->count() > 0) {
            $offers = [
                [
                    ...
                    'offer_message' => 'أهلاً، أنا مهتم بأرضك وأريد شراءها بسعر 750,000 ريال. هل يمكننا التواصل لمناقشة التفاصيل؟',
                ...
                [
                    ...
                    'offer_message' => 'أريد شراء الأرض بسعر 580,000 ريال نقداً. هل يمكننا الاتفاق على هذا السعر؟',
                ...
                [
                    ...
                    'offer_message' => 'أهلاً، أريد شراء الأرض بسعر 780,000 ريال. أنا جاد في الشراء ويمكنني إتمام الصفقة بسرعة.',
                    'offerer_name' => 'فاطمة أحمد',
                    'offerer_phone' => '+966 55 987 6543',
                    'offerer_email' => 'fatima@email.com',
                    'status' => 'pending'
                ...
                [
                    ...
                    'offer_message' => 'أهلاً، أنا مهتم بأرضك التجارية وأريد شراءها بسعر 1,900,000 ريال. هل يمكننا التواصل؟',
                    'offerer_name' => 'محمد علي',
                    'offerer_phone' => '+966 50 123 4567',
                    'offerer_email' => 'mohammed@email.com',
                    'status' => 'pending'
